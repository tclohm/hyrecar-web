...
export const schema = yup.object().shape({
	...
	firstName: yup.string('Enter your first name').min(1, 'First name must be more than 1 characters').max(255, 'First name must not be more than 255 characters').required('First name is required'),
